...
const userSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ['superAdmin', 'admin', 'organizationOwner', 'manager', 'accountManager', 'editor', 'designer', 'adsManager', 'financeManager', 'clientAdmin', 'clientMember', 'intern', 'employee', 'referral', 'client'],
      default: 'employee',
    },
