...
const taskFormSchema = z.object({
  ...
  taskType: z.enum(['task', 'content', 'reel', 'poster', 'video']).default('task'),
...
export const AddTaskModal = ({ open, onOpenChange, task = null, initialValues = {} }) => {
  const form = useForm({
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {task ? 'Update the task details' : 'Create a new task to track work'}
          </DialogDescription>
        </DialogHeader>
                ...
                <FormItem className="flex flex-row items-center justify-between rounded-2xl border border-border bg-secondary/20 p-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      Allow the client to see this task in their project workspace.
                    </p>
                  </div>
                  <FormControl>
                    <input
